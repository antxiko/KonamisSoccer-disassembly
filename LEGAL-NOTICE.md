...
**The game is not ours.** *Konami's Soccer* was published by **Konami** for the MSX in 1985;
its catalogue number is **RC-732** and it is 32 KB. All rights over the game
...
The file `src/soccer.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Konami's Soccer* or hold rights over the game, and you would rather this
